...
<head>
    ...
    <title>Косметология - Nova Beauty</title>
    <link rel="stylesheet" href="services3.css">
    ...
    <main class="main">
        <div class="container">
            <section class="services">
                <h1 class="services__title">Косметология</h1>
                    ...
                    <div class="tables-row">
                        <div class="price-block haircuts-block">
                            <table class="price-table haircuts-table">
                                ...
                                <tbody>
                                    <tr>
                                        <td>Экспресс-уход для лица</td>
                                        <td>7000/7500 ₽</td>
                                    </tr>
                                    <tr>
                                        <td>Уход для лица по типу кожи</td>
                                        <td>1100/1400 ₽</td>
                                    </tr>
                                    <tr>
                                        <td>Индивидуальный ритуал</td>
                                        <td>11 000 ₽</td>
                                    </tr>
                                    <tr>
                                        <td>Сияние молодости</td>
                                        <td>14 000 ₽</td>
                                    </tr>
                                </tbody>
                            </table>
