...
<head>
    ...
    <title>Ногтевой сервис - Nova Beauty</title>
    ...
    <main class="main">
        <div class="container">
            <section class="services">
                <h1 class="services__title">Ногтевой сервис</h1>
                    ...
                    <div class="tables-row">
                        ...
                        <div class="price-block blonding-block">
                            <table class="price-table blonding-table">
                                <thead>
                                    <tr>
                                        <th>Маникюр без покрытия</th>
                                        <th>Стоимость</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td>Маникюр без покрытия</td>
                                        <td>2500/3000 ₽</td>
                                    </tr>
                                    <tr>
                                        <td>Пилочный маникюр без покрытия</td>
                                        <td>2700/3200 ₽</td>
                                    </tr>
                                    <tr>
                                        <td>Baby-маникюр</td>
                    ...
                    <div class="tables-row">
                        <div class="price-block coloring-block">
                            <table class="price-table coloring-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Пилочный маникюр+гель лак</td>
                                        <td>3800/4300 ₽</td>
                                    </tr>
                                    <tr>
                                        <td>Маникюр+«недельный лак»</td>
                                        <td>2800/3300 ₽</td>
                                    </tr>
                                    <tr>
                                        <td>Пилочный маникюр</td>
                                        <td>2800/3300 ₽</td>
                                    </tr>
                                    <tr>
                                        <td>Комплекс наращивание ногтей</td>
                                        <td>6300/6800 ₽</td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <div class="price-block highlighting-block">
                            <table class="price-table highlighting-table">
                                <thead>
                                    <tr>
                                        <th>Комплекс педикюр</th>
                                        <th>Стоимость</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td>Аппаратный педикюр+гель лак</td>
                                        <td>4200/4700 ₽</td>
                                    </tr>
                                    <tr>
                                        <td>SMART педикюр+гель лак</td>
                                        <td>4700/5200 ₽</td>
                                    </tr>
                                    <tr>
                                        <td>Педикюр Golden+гель лак</td>
                                        <td>5300/5800 ₽</td>
                                    </tr>
                                </tbody>
                            </table>
